            ...
            <div className="m-0 grid h-[100%] grid-cols-1 bg-[white] p-0 sm:grid-cols-5 ">
                <div className="border-r border-black p-4 sm:col-span-3">
                    <div className="mb-2 flex h-[70px]  w-[100%] border-l-8 border-[#FF7F50] bg-[white] shadow-sm">
                        ...
                        <div className="flex  flex-1 items-center pl-2 text-xl">
                            <p>Recorrido ruta Concepcion</p>
                        </div>
                    </div>
                    <div className="h-[500px] w-full bg-cyan-300"><Concepcion /></div>
                ...
                <div className="flex justify-center border-r border-black p-4 sm:col-span-2">
                    <div className="w-[100%] rounded-xl">
                        ...
                        <Location parada="San Mateo" />
                        <Location parada="La esperanza" />
                        <Location parada="Interplaza" />
                        <Location parada="Mariano Galvez" />
                        <Location parada="Periferico" />
                        <Location parada="Rotonda Tecún Umán" />
                    </div>
                </div>
            </div>
        </div>
