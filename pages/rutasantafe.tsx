    ...
    return (
        <div className="h-screen w-screen overflow-x-hidden bg-[white]">
            ...
            <div className="m-0 grid h-[100%] grid-cols-1 bg-[white] p-0 sm:grid-cols-5 ">
                ...
                <div className="mb-2 flex h-[70px]  w-[100%] border-l-8 border-[#00FA9A] bg-[white] shadow-sm">
                        ...
                        <div className="flex  flex-1 items-center pl-2 text-xl">
                            <p>Recorrido ruta Santafe</p>
                        </div>
                    </div>
                    <div className="h-[500px] w-full bg-cyan-300"><Santafe /></div>
                ...
                <div className="flex justify-center border-r border-black p-4 sm:col-span-2">
                    <div className="w-[100%] rounded-xl">
                        ...
                        <Location parada="La esperanza" />
                        <Location parada="Interplaza" />
                        <Location parada="Mariano Galvez" />
                        <Location parada="Hospital" />
                        <Location parada="Pradera" />
                        <Location parada="USAC" />
                        <Location parada="Zoologico" />
                        <Location parada="Complejo CDAG" />
                        <Location parada="Plaza Japon" />
                        <Location parada="Democracia" />
                        <Location parada="Parque Centro America" />
                        <Location parada="El Bolibar" />                
                    </div>
                </div>
            </div>
        </div>
