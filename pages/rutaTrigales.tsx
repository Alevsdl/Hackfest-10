        ...
        <div className="h-screen w-screen overflow-x-hidden bg-[white]">
            ...
            <div className="m-0 grid h-[100%] grid-cols-1 bg-[white] p-0 sm:grid-cols-5 ">
                <div className="border-r border-black p-4 sm:col-span-3">
                    <div className="mb-2 flex h-[70px]  w-[100%] border-l-8 border-[#ffff66]  bg-[white] shadow-sm">
                        ...
                        <div className="flex  flex-1 items-center pl-2 text-xl">
                            <p>Recorrido ruta Trigales</p>
                        </div>
                    </div>
                    <div className="h-[500px] w-full bg-cyan-300"><Trigales /></div>
                ...
                <div className="flex justify-center border-r border-black p-4 sm:col-span-2">
                    <div className="w-[100%] rounded-xl">
                        ...
                        <Location parada="Colonia Trigales" />
                        <Location parada="Jardines" />
                        <Location parada="Rotonda Tecun Uman" />
                        <Location parada="Utz Ulew" />
                        <Location parada="Democracia" />
                        <Location parada="Parque Centro America" />
                        <Location parada="Parque Bolivar" />
                        <Location parada="Monumento a la Marimba" />
                        <Location parada="Parque Benito Juarez" />
                        <Location parada="Centro Regional de Justicia de Quetzaltenango" />
                    </div>
                </div>
            </div>
        </div>
